...
- `fullname` (string, required):Captain's name
...
- `captain` (object):
  - `fullname` (string):captain's fullname   
...
Logout the current captain and blacklist the token provided in  headers.
